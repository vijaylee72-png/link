            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 mb-16">
              <div>
                ...
                <h2 className="text-5xl md:text-6xl font-bold mb-8 text-white leading-tight">
                  ...
                  <span className="block text-[18px] md:text-[22px] mt-4 opacity-40 font-medium tracking-normal">A Think Tank of Seasoned Practitioners</span>
                </h2>
                ...
                <div className="space-y-8 text-[15px] text-muted-foreground leading-relaxed max-w-xl">
                  <p>
                    ...
                    <span className="block mt-2 opacity-60 font-normal italic">Linkwise Global Limited is a professional consulting firm focusing on the Internet, consumer goods, and cross-border e-commerce sectors. We bring together industry veterans to form a professional think tank team.</span>
                  </p>
                  <p>
                    公司業務覆蓋戰略、營運、品牌、供應鏈、合規和數字化等多個維度，為客戶企業的全週期發展提供定制化專業服務，助力客戶實現突破性增長和可持續的長遠成功。
                    <span className="block mt-2 opacity-60 font-normal italic">Our business covers multiple dimensions including strategy, operations, branding, supply chain, compliance, and digitalization. We provide customized professional services for the full-cycle development of client enterprises, helping them achieve breakthrough growth and sustainable long-term success.</span>
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-8">
                ...
                >
                  ...
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                      ...
                      <div className="text-[10px] text-muted-foreground font-medium uppercase tracking-widest">Based in Hong Kong, Global Vision</div>
                    </div>
                  </div>
                  <p className="text-[14px] text-muted-foreground leading-relaxed">
                    總部位於香港灣仔華潤大廈，借助香港國際金融中心的獨特地位，搭建中國企業與全球資本的橋樑。
                    <span className="block mt-2 opacity-60 italic">Headquartered in the China Resources Building, Wan Chai, Hong Kong, we leverage Hong Kong's unique status as an international financial center to build a bridge between Chinese enterprises and global capital.</span>
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <h3 className="text-2xl font-bold text-white mb-2">我們的使命 · OUR MISSION</h3>
                  <div className="text-primary text-[11px] font-bold tracking-widest uppercase mb-8 italic">Empowering Growth</div>
